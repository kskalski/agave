...
impl AccountsDb {
    ...
    pub fn generate_index(
        ...
        for pass in 0..passes {
            ...
            let chunk_size = accounts_scan_par_chunk_size(outer_slots_len);
...
fn accounts_scan_par_chunk_size(outer_slots_len: usize) -> usize {
    let threads = num_cpus::get();
    // approximately 400k slots in a snapshot
    (outer_slots_len / (std::cmp::max(1, threads.saturating_sub(1)))) + 1
}
